...
-- Openbravo v2.80 - uniCenta v3.00
...
ALTER TABLE PRODUCTS ADD COLUMN ISKITCHEN BOOLEAN NOT NULL SET DEFAULT FALSE;
ALTER TABLE PRODUCTS ADD COLUMN PRINTKB BOOLEAN NOT NULL SET DEFAULT FALSE;
ALTER TABLE PRODUCTS ADD COLUMN SENDSTATUS BOOLEAN NOT NULL SET DEFAULT FALSE;
ALTER TABLE PRODUCTS ADD COLUMN ISSERVICE BOOLEAN NOT NULL SET DEFAULT FALSE;
